...
public final class PaperBlockPacketNameTag extends BlockPacketNameTag implements PaperNametagRow {

    private final UnlimitedNameTags plugin;

    public PaperBlockPacketNameTag(@NotNull UnlimitedNameTags plugin, @NotNull Player owner,
